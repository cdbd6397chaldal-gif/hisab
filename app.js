...
function generateSmsText(cat, name, take, give, totalAmt, remainingAmt) {
  const amt = take || give;
  let msg = '';
  if (cat === 'Giving Loan') msg = `আপনি ${name} কে ${amt} টাকা লোন দিয়েছেন।`;
  else if (cat === 'Taking Loan') msg = `আপনি ${name} এর কাছ থেকে ${amt} টাকা লোন নিয়েছেন।`;
  else if (cat === 'Loan Paid') msg = `${give} টাকা পরিশোধ হয়েছে। বাকি আছে ${remainingAmt} টাকা।`;
  else if (cat === 'Loan repaid') msg = `${name} ${give} টাকা ফেরত দিয়েছেন। বাকি আছে ${remainingAmt} টাকা।`;
  else if (cat === 'Credit Purchase') msg = `${name} এর কাছ থেকে ${amt} টাকার বাকি কেনাকাটা হয়েছে।`;
  else if (cat === 'Credit Purchase Loan Paid') msg = `${give} টাকা বাকি পরিশোধ হয়েছে। বাকি আছে ${remainingAmt} টাকা।`;
  return msg;
}
